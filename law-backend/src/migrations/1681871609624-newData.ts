...
export class newData1681871609624 implements MigrationInterface {
    name = 'newData1681871609624'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "services" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" integer NOT NULL, "name" character varying NOT NULL, "shortName" character varying NOT NULL, "password" character varying NOT NULL, "role" "public"."services_role_enum" NOT NULL DEFAULT 'service', CONSTRAINT "UQ_f019a17cb439406ab185382df9b" UNIQUE ("code"), CONSTRAINT "UQ_019d74f7abcdcb5a0113010cb03" UNIQUE ("name"), CONSTRAINT "UQ_be709230328e62bf866064c933d" UNIQUE ("shortName"), CONSTRAINT "PK_ba2d347a3168a296416c6c5ccb2" PRIMARY KEY ("id"))`);
