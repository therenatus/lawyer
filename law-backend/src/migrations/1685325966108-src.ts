...
export class src1685325966108 implements MigrationInterface {
    name = 'src1685325966108'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "number" character varying NOT NULL, "title" character varying NOT NULL, "contrAgent" character varying NOT NULL, "tagList" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "endDate" TIMESTAMP NOT NULL DEFAULT now(), "status" "public"."documents_status_enum" NOT NULL DEFAULT 'todo', "fileName" character varying, "filePath" character varying, "price" character varying NOT NULL, "authorId" uuid, "initiatorsId" uuid, "categoryId" uuid, CONSTRAINT "PK_ac51aa5181ee2036f5ca482857c" PRIMARY KEY ("id"))`);
